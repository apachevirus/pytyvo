<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="text" maxlength="25" name="name" id="inputName" class="form-control" placeholder="" required>
        </div>
    </div>
</div>
<div class="form-group">
    <div class="row">
        <div class="col-md-12">
            ...
            <input type="email" maxlength="100" name="email" id="inputEmail" class="form-control" placeholder="" required>
        </div>
    </div>
</div>
<div class="form-group">
