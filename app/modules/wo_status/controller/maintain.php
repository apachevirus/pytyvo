...
include_once dirname(__DIR__) . '/model/WOStatus.inc.php';
include_once dirname(__DIR__) . '/model/WOStatusRepository.inc.php';
include_once dirname(__DIR__) . '/model/WOStatusValidator.inc.php';
...
define('ROUTE_MANAGER', ROUTE_ADMINISTRATION_SETUP_SERVICE_WO_STATUS_MANAGER);
define('ROUTE_MAINTAIN', ROUTE_ADMINISTRATION_SETUP_SERVICE_WO_STATUS_MAINTAIN);
