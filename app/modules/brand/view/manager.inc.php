...
<div class="container rounded pt-3" style="background: white;">
    ...
    <div class="row mb-5">
        <div class="col-md-6">
            <h1>
                <i class="icofont icofont-brand-volkswagen"></i> Marcas
        ...
        <div class="col-md-6">
            <form class="form-inline mt-2 mt-md-2 float-right" method="post" action="<?php echo ROUTE_MANAGER; ?>">
                <input type="text" class="form-control mr-sm-2" id="inputSearch" name="search" maxlength="50" placeholder="Buscar..." aria-label="Buscar" value="<?php echo $brand_search; ?>" autofocus>
