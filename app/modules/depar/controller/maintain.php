...
include_once dirname(__DIR__) . '/model/Depar.inc.php';
include_once dirname(__DIR__) . '/model/DeparRepository.inc.php';
include_once dirname(__DIR__) . '/model/DeparValidator.inc.php';
...
define('ROUTE_MANAGER', ROUTE_ADMINISTRATION_SETUP_GENERAL_DEPAR_MANAGER);
define('ROUTE_MAINTAIN', ROUTE_ADMINISTRATION_SETUP_GENERAL_DEPAR_MAINTAIN);
