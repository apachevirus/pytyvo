...
<div class="container rounded">
    <div class="row p-4" style="background: white;">
        <div class="col-md-12">
            ...
            <a class="quick-btn" href="<?php echo ROUTE_ADMINISTRATION_SETUP_INVENTORY_CATEGORY_MANAGER; ?>">
                <i class="far fa-window-maximize" style="font-size: 1.5rem;"></i>
                <span>Rubros</span>
            </a>
            <a class="quick-btn" href="<?php echo ROUTE_ADMINISTRATION_SETUP_INVENTORY_SUBCATEGORY_MANAGER; ?>">
                <i class="far fa-window-maximize" style="font-size: 1.5rem;"></i>
                <span>Subrubros</span>
            </a>
